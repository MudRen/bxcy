...
if ((int)me->query_skill("wuji-shengong", 1) < 1000)	
return notify_fail("你的无极神功火候不够，无法学排云掌。\n");
	if ((int)me->query("max_neili") < 100)
return notify_fail("你的内力太弱，无法练排云掌。\n");
if ((int)me->query_skill("fanyun-zhang", 1) > 300)	
return notify_fail("该教的都教给你了,以后自己多加体会研习吧。\n");	
	return 1;
}
