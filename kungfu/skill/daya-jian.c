...
mapping *action = ({
    ([  "action": 
"只见$N手中$w舞动出一片网状，使出大雅古剑法第一式：「盘庚式」，\n	
将$n周围尽皆罩住。\n",	
        "parry_msg" :
...
"parry_power":          10,
 //       "jibie" :15,
        ...
        "damage_type":"割伤"    ]),
    ([  "action":
"只见$N手中$w挥动一股霸道的剑气，正是大雅古剑法第二式：「毕命式」，\n   "	
"对着$n左右斜劈，凛然有风。",    	
        "parry_msg"  :
...
//        "jibie" :30,
        ...
        "damage_type":"割伤" ]),
    ([  "action":
"只见$N手中$w闪出点点剑光，联成一线，正是大雅古剑法第三式：「罔命式」，\n "
"$w带动光线，在$n面前挥舞。",
        "parry_msg"  :
...
//        "jibie" :60,
        ...
        "damage_type":"割伤"    ]),
        ([      "action":
"只见$N手中$w发出龙吟之声，阴阳相和，高声琨，正声缓，正是大雅古剑法\n   "	
"第五式：「瞽蒙式」，剑锋直向$n左肩刺过去。",
                "parry_msg" :
"$n使出「“比”字诀」，口中念道：舍逆取顺。\n  "	
"$n低头躲过$N这一招，闪身跃开。",
...
//        "jibie":75,
        ...
        ([      "action":
"只见$N身体在原地游走，脚步散而不乱，正是大雅古剑法第六式：「述而式」，\n	"
"手中$w摆动，不时向$n刺出一剑。",
                "parry_msg" :
