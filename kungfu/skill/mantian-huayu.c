...
{
      if (me->query_skill("throwing",1) <= me->query_skill("mantian-huayu",1))
...
int practice_skill(object me)
{
    ...
    if (me->query_temp("pratice_throwing") > me->query_skill("mantian-huayu",1)/20 ){
...
void do_interlink(object me, object victim)
{
    ...
    if (!weapon) return;
    skill=me->query_skill("mantian-huayu", 1);
    if (random(skill)>250){
