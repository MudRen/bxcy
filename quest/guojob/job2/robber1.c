...
/* copy hp */
me->set("qi",(ob->query("max_qi")*1/2));
me->set("eff_qi",(ob->query("max_qi")*1/2));
me->set("max_qi",(ob->query("max_qi")*1/2));
me->set("max_jing",(ob->query("max_jing")*1/2));
me->set("eff_jing",(ob->query("max_jing")*1/2));        
me->set("jing",(ob->query("max_jing")*1/2));
