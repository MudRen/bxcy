...
message("shout", HIB"【朝廷急报】"GRN + "有消息说：蒙古靼子马上要侵犯襄阳了!\n"NOR,users() );
	if (me->query("shen")>0)
	{
        switch( random(2) ) {
                case 0:
...
//        me->add("eff_qi",-me->query("max_qi")/10);
        ...
        if (random(4) == 0)
        {
message("shout", HIB"【襄阳战报】"HIW + "一队宋军伤兵，退到了襄阳城中心附近!\n"NOR,users() );
        ...
        if (random(4) == 1)
        {
message("shout", HIB"【襄阳战报】"HIW + "一队蒙古精兵，冲进了襄阳城北门附近!\n"NOR,users() );
        ...
        if (random(4) == 2)
        {
message("shout", HIB"【襄阳战报】"HIW + "一大队蒙古兵，冲进了襄阳城西门附近!\n"NOR,users() );
        ...
        if (random(4) == 3)
        {
message("shout", HIB"【襄阳战报】"HIW + "有几名蒙古奸细，混进了襄阳城南门附近!\n"NOR,users() );
