...
set("eff_qi",13959999);
set("max_qi",13959999);
set("eff_jing",12909999);
set("jing",12909999);
set("max_jing",12909999);
set("neili",29909999);	
set("no_suck",1);	
set("jiali",10);
set("max_neili",29909999);	
  set("max_sen",109999);
  set("max_mana",109999);
...
if (!killer) return;
CHANNEL_D->do_channel( this_object(), "sys", sprintf("千年火龙王被%s(%s)杀死了。", killer->name(),killer->query("id")));
