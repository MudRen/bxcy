...
void create()
{
string file = "/d/taishan/obj/bingqipu.o";   	

set_name(HIR "江湖兵器谱" NOR, ({ "bingqi pu","pu" }) );	
        
        set("unit", "本");
        set("long", HIW"这是一本流传久远的江湖兵器谱，里面记下了江湖上的成名兵器。

可以用(read pu)来翻看记载，	
可以用(ping pu)来评定自己兵器的排名。                          	
\n"NOR);
        set("material","paper");
        ...
        if( file_size(file) > 0 )
restore_object("/d/taishan/obj/bingqipu");   	
...
save_object("/d/taishan/obj/bingqipu");	
