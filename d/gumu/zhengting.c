...
int do_sleep(string arg)
{
        ...
        int lvl_force, c_exp, c_skill, y_skill;
        ...
        if(lvl_force>150) //force 大于 150
                ...
                if (random(20)>12) {
                        ...
                        y_skill=me->query_skill("yunv-xinfa",1);
                        if ( ((c_skill*c_skill*c_skill/10)< c_exp) && (c_skill<600) && (y_skill<300) )
                        {
                                me->improve_skill("force", random(lvl_force));
                                me->improve_skill("yunv-xinfa",lvl_force/10);
                        }
