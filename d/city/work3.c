...
if ((cot>15)||me->query("combat_exp")>500000000) {       	
...
//      message("vision",HIY"〖谷物加工厂〗"NOR+":"+YEL" 中秋嘉节,由于"HIW+me->name()+NOR YEL"工作勤劳，获得了豪侠晚歌节日奖品1000两黄金!\n"NOR,users());       	
...
ob = new("/clone/money/gold");	
ob->set_amount(1+random(8));	
            me->add("combat_exp",random(80));
