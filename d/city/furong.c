...
void create()
{
        set("short", HIY"Ü½ÈØÑçÌü"NOR);
        set("long", @LONG
½øÃÅÈÆ¹ıÒ»µÀµ­ÂÌ³ñÆÁ·ç£¬Ó­ÃæÇ½ÉÏ¹Ò×ÅÒ»¸±¡ºÜ½ÈØ³öË®¡»Í¼£¬¹¤±Ê²Ê
»æ£¬×´¼«ÇåÑÅ£¬ÆøÖÊ×¿¾ø¡£ÌüÄÚ³ÂÁĞÉİ»ª£¬ÕıÖĞÑëÒ»ÕÅµñ»¨éªÄ¾ÇàÆáÇ¶Óñ´ó
Ô²×À£¬ËÄÖÜÊ®¶şÕÅÏâÒøÏóÑÀ·öÊÖºìÄ¾ÒÎ£¬±­ÍëÉ×óç£¬ÈëÑÛÉú»Ô¡£
    ÕâÀï±ãÊÇ×íÏÉÂ¥µÄÜ½ÈØÌü£¬×ÀÉÏÆ½ÆÌ×ÅÒ»·İ²Ëµ¥(menu)¡£
LONG );
        set("exits", ([ /* sizeof() == 1 */
...
int do_broadcast(string arg)
{
        ...
        if (type == "marry") {
                mesg = me->name() + "ÏÖÔÚÔÚ×íÏÉÂ¥Ü½ÈØÌü¾ÙĞĞ¶©»é¾ÆÑçÁË  !!!\n";
        } else if (type == "player") {
                mesg = me->name() + "ÏÖÔÚÔÚ×íÏÉÂ¥Ü½ÈØÌüÑçÇë¸÷Â·Ó¢ĞÛºÀ½Ü  !!!\n";
       }
