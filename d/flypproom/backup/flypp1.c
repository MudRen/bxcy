...
set("chat_chance", 5); 	          	
set("chat_msg", ({
"哎,闯荡江湖这么多年,怎么就没碰上个对手,无敌最寂寞...,现在我总算体会到了... ...。\n", 
(: command, "chat* 叹道: 近来江湖日渐衰竭,现在没几个人能接我一招,看来我终究还是要孤独一生" :),       	   	
(: command, "chat* sigh" :),
(: command, "chat* 说道: 想来找我吗? 武林盟主那 look 宝座,如果你没点本事的话,那就算了!..." :), 
(: command, "chat* 说道: 我靠,叫的那么辛苦都没人来,你们都白痴啊,一个小迷也解不掉,TNND" :), 	
}) );
setup();
...
command("say 呵呵，骂你不服气吗? 来单挑哈:)！");             		
command("kok wenwu");                                  	
command("kick wenwu"); 
*/
/*
if (me->query("id")=="lisa") {
command("say 小妹妹,来看哥哥了啊,乖哦:)！");             		
command("kiss lisa");                                  	
command("ppp lisa");
*/
/*
if (me->query("id")=="loveall") {
command("say 呵呵,好像,好像,实在太像了");             		
*/
