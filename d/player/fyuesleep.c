...
void create()
{
        set("short", "卧雪轩");
        set("long",
"这是龙云梦和冰雁的卧室，屋内摆设挺简单的，显得窗明几净的。门	
的一进门就面对着一张漂亮的梳妆台，这就是冰雁平时打扮的地方	
了。这可是冰雁的命根子耶。右边是一张双人大床，不用说也可以知	
道那是冰雁和龙云梦休息的地方了。床上铺着一张牡丹花底的床单，	
看起来好舒服好舒服的。靠右方的角上摆了一个大衣柜，里面当然放
着冰雁和龙云梦的衣服。理所当然的里面大多数是冰雁的衣服。房子	
左边有一块蒲团，那是他们练功的地方。也就是那里，造就了龙云梦	
和冰雁这对神仙侠侣。\n"	
);
        set("exits", ([ 
