...
int main(object me, string arg)
{
	...
	{
	        write(ALERT("此人现在不在线上，听不到你的话。\n"));
		return 1;
	}
	if (! living(obj))
	{
	        write(ALERT("这人现在恐怕听不到你说的话了...\n"));
		return 1;
	}
	/*
        if (! obj->query_temp("tomud"))
        {
                write(ALERT("这人使用的不是 ToMud 客户端，你还是用 tell 指令和他聊天吧...\n"));  
                return 1;
        }
        */
        ...
        if (! obj->query_temp("tomud"))
                ...
                tell_out = TMI("ctell name="+my_name+";ID="+my_id+";icon="+me->query("icon")+";"+msg); 
