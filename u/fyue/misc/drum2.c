...
{
     if (!arg) return "";
    if( (strsrch(arg, "本月成年组第一") >= 0)
      ||(strsrch(arg, "本月成年组第二") >= 0)
      ||(strsrch(arg, "本月成年组第三") >= 0))
        {
        arg = replace_string(arg, HIY+"本月成年组第一"+NOR,"");
        arg = replace_string(arg, HIY+"本月成年组第二"+NOR,"");
        arg = replace_string(arg, HIY+"本月成年组第三"+NOR,"");
        }
    return arg;
}
