...
if(j < 4 )	
message("channel:chat", HIY"【华山论剑】"+HIM"到场人数不够,取消本次论剑大会！\n"NOR,users() );             	
if(j >= 4 )     	
...
new("/clone/money/thousand-gold")->move(no1);	
new("/clone/money/thousand-gold")->move(no1);	
new("/clone/money/thousand-gold")->move(no1);	
new("/clone/money/thousand-gold")->move(no1);	
new("/clone/money/thousand-gold")->move(no1);	
...
new("/clone/money/thousand-gold")->move(no2);	
new("/clone/money/thousand-gold")->move(no2);	
new("/clone/money/thousand-gold")->move(no2);	
...
new("/clone/money/thousand-gold")->move(no3);	
