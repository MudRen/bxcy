...
write("                    "+BGRN HIW"以下是你目前使用中的特殊技能\n\n"NOR);
        ...
        if( map_to=="none" ) {
                me->map_skill(ski);
                me->reset_action();
              write("你放弃使用"+HIW+CHINESE_D->chinese(ski)+NOR"的特殊技能。\n");
...
//                      + to_chinese(map_to) + "了。\n");
        ...
        me->reset_action();
        write("你起用"HIR+CHINESE_D->chinese(map_to)+NOR"作为"HIW+CHINESE_D->chinese(ski)+NOR"的特殊技能。\n");
