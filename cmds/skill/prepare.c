...
{
        write(@HELP
指令格式 : prepare [<拳术技能名称>|<拳术技能名称> | none]
           prepare ?
...
对于以下的武功，你需要准备它才能使用：
	...
	"strike":   "掌法",
例如：拈花指 (nianhua-zhi)
	enable finger nianhua-zhi
        prepare nianhua-zhi
也可以组合两种特殊技能：
例如：拈花指 (nianhua-zhi)可以和散花掌 (sanhua-zhang)组合:
> enable finger nianhua-zhi
Ok.
> enable strike sanhua-zhang
Ok.
> prepare nianhua-zhi sanhua-zhang
完成技能准备。
HELP
        );
        return 1;
